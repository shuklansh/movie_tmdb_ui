...
class _DetailedScreenState extends State<DetailedScreen> {
  ...
  Future getYTtail() async{
    ...
    print("1111111111 inside getyt");

  }

  // Future controllerinitialize() async{
  //   setState(() {
  //   controller = YoutubePlayerController(
  //       initialVideoId: linkTail,
  //       flags: YoutubePlayerFlags(
  ...
  void initState() {
    ...
    print(linkTail + "      11111111  before getyt" );

    getYTtail();

    print(linkTail + "     11111111  after getyt" );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: linkTail!="Default"? YoutubePlayerBuilder(
